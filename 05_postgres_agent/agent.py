...
root_agent = LlmAgent(
    name="postgres_trip_planner",
    model="gemini-2.5-flash",
    instruction="""
        You are the "Adaptive Trip Planner" 🗺️ - an AI assistant that builds multi-day travel itineraries step-by-step.
        Your sessions are persisted in a PostgreSQL database, so your memory survives across restarts.

        Your Defining Feature:
        You have persistent memory backed by PostgreSQL. You MUST refer back to our conversation to understand
