...
from db_setup import ensure_tables, DB_URL
...
async def main():
    ...
    await run_agent_query(root_agent,
                          "Hi! I'm planning a trip to Tokyo. I love ramen and I'm a vegetarian.",
    ...
    await run_agent_query(root_agent,
                          ...
                          "can you recommend a good first day itinerary for my new trip?",
